/*
 * RoleEmptyFailure.java
 *
 * Created on November 20, 2008, 8:27 PM
 */
 ...
 * @version
 */
public class RoleEmptyFailure extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Trade Failed</title>");
        out.println("</head>");
        out.println("<body>");
        ...
        out.println("<h4>Your trade was not executed!<br><br> Please click " +
                "<a href=\"NewLogin\">here</a> to login again. </h4>");
